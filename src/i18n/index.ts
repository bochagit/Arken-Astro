...
export const ui = {
	es: {
		...
		'footer.copyright': '© 2025 Arken Games. Todos los derechos reservados.',
		'footer.news': 'Enterate de todas nuestras novedades!',
		'footer.newsletter': 'Síguenos en redes',
		'games.title': 'Conoce nuestros juegos:',
		'games.gallery': 'Galería',
		'games.related': 'Juegos relacionados',
		'games.buy': 'Comprar',
	...
	en: {
		...
		'footer.copyright': '© 2025 Arken Games. All rights reserved.',
		'footer.news': 'Find out about all our news!',
		'footer.newsletter': 'Follow us on social media',
		'games.title': 'Discover our games:',
		'games.gallery': 'Gallery',
		'games.related': 'Related games',
		'games.buy': 'Buy',
